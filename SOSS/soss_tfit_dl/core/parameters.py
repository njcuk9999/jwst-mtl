...
params.set(key='model', value=1, source=__NAME__,
           desc='Transit model to use',
           dtype=int, path='global_params.model')
...
# Number of planets (use for N planets) [FLOAT], for SPOTROD
params.set(key='NSPOTS', value=0, source=__NAME__,
           desc='Number of star spots to use',
           dtype=int, path='global_params.nspots')
...
# =============================================================================
# Define default trend parameters
#       Note FitParam value = None dtype=FitParam
# =============================================================================
# number of trends
params.set(key='NTRENDS', value=0, source=__NAME__,
           desc='Number of trends to apply',
           dtype=int, path='global_params.ntrends')

# trend coefficient [PARAM]
params.set(key='TREND_C', value=None, source=__NAME__,
           desc='Coefficient of trend',
           dtype=FitParam, path='global_params.trend_c{N}', label='TC')
...
params.set(key='THINNING', value=10, source=__NAME__,
           desc='Thinning to apply to the chains',
           dtype=int, path='mcmc_params.thinning')
...
params.set(key='CONVERGE_CRIT', value=1.02, source=__NAME__,
           desc='Convergence criteria',
           dtype=float, path='mcmc_params.converge_crit')

# Convergence criteria for buffer
params.set(key='BUFFER_CONVERGE_CRIT', value=1.2, source=__NAME__,
           desc='Convergence criteria for buffer',
...
params.set(key='RHO_STAR', value=None, source=__NAME__,
           ...
           dtype=FitParam, path='star.rhostar', label='RHO')
...
###Teff and logg, needed when sampling those to get q1 & q2 from models
# star effective temperature [PARAM]
params.set(key='TEFF', value=None, source=__NAME__,
           desc='Effective temperature',
           dtype=FitParam, path='star.teff', label='TEFF')

# star surface gravity [PARAM]
params.set(key='LOGG', value=None, source=__NAME__,
           desc='Surface gravity',
           dtype=FitParam, path='star.logg', label='LOGG')

# star surface gravity [PARAM]
params.set(key='METAL', value=None, source=__NAME__,
           desc='Stellar metallicity',
           dtype=FitParam, path='star.metal', label='METAL')



###LD coeff for spotrod model
# Limb-darkening param q1. [PARAM]
params.set(key='Q1', value=None, source=__NAME__,
           desc='Limb-darkening param q1',
           dtype=FitParam, path='star.q1', label='q1')

# Limb-darkening param q2. [PARAM]
params.set(key='Q2', value=None, source=__NAME__,
           desc='Limb-darkening param q2',
           dtype=FitParam, path='star.q2', label='q2')

###SPOT parameters### for SPOTROD

# SPOT X position. [PARAM]
params.set(key='SPOTX', value=None, source=__NAME__,
           desc='Stellar spot x position',
           dtype=FitParam, path='spot{N}.x', label='SX')

# SPOT Y position. [PARAM]
params.set(key='SPOTY', value=None, source=__NAME__,
           desc='Stellar spot y position',
           dtype=FitParam, path='spot{N}.y', label='SY')

# SPOT radius. [PARAM]
params.set(key='SPOTR', value=None, source=__NAME__,
           desc='Stellar spot radius',
           dtype=FitParam, path='spot{N}.rad', label='SR')

# SPOT contrast. [PARAM]
params.set(key='SPOTC', value=None, source=__NAME__,
           desc='Stellar spot contrast',
           dtype=FitParam, path='spot{N}.cont', label='SC')
...
# Semi-major axis [PARAM]
params.set(key='SMA', value=None, source=__NAME__,
           desc='Semi-major axis',
           dtype=FitParam, path='planet{N}.sma', label='SMA')
