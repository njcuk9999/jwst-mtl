...
from soss_mtl.core.core import general
from soss_mtl.core.core import exceptions
...
def _read_from_config_file(params: ParamDict, args: argparse.Namespace,
    ...
    elif SOSSDIR in os.environ:
        workingdir = Path(os.environ[SOSSDIR])
...
def _setup_working_directory(params: ParamDict,
    ...
    if SOSSDIR in os.environ:
        default_dir = Path(os.environ[SOSSDIR])
    else:
